    ...
    return (
        <section className="pt-3 pb-10">
            <div className="flex items-center gap-3">
                ...
                <p className="text-sm">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium adipisci delectus deserunt modi nemo tenetur, vero voluptatum? Id, perspiciatis quae?
                </p>
            </div>
            ...
            <p className="text-sm">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Commodi iure, iusto libero maxime non nostrum nulla omnis quidem ratione sit.
            </p>
        </section>
    )
}
